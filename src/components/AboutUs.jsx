        ...
        <>
            <div className="grid lg:grid-cols-2 md:gap-2 ml-12 pb-24">
                ...
                <div className="bg-yellow-50/40  rounded-xl mx-10 my-10 shadow-2xl  backdrop-brightness-150 backdrop-blur-3xl bg-opacity-90 hover:bg-amber-500/10 w-3/4 ">
                    <div className="grid grid-cols-4 h-full">
                        <div className="bg-amber-500/80 rounded-tl-lg rounded-bl-lg text-5xl text-white flex items-center justify-center col-span-1">
                            IA
                        </div>
                        <div className="pb-10 p-5 col-span-3">
                ...
                <div className="bg-yellow-50/40  rounded-xl mx-10 my-10 shadow-2xl  backdrop-brightness-150 backdrop-blur-3xl bg-opacity-90 hover:bg-emerald-800/10 w-3/4 ">
                    <div className="grid grid-cols-4 h-full">
                        <div className="bg-emerald-800/80 rounded-tl-lg rounded-bl-lg text-5xl text-white flex items-center justify-center col-span-1">
                            AG
                        </div>
                        <div className="pb-10 p-5 col-span-3">
